...
function Articles() {
  ...
  return (
    <div>
      <div>
        <div
          style={{ backgroundImage: `url(${rotated})` }}
          className=" p-2 pb-5 bg-cover bg-center bg-no-repeat"
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 max-w-6xl mx-auto">
              ...
              >
                ...
                <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  How can you select the best courses to align with your future
                  career goals?
                </h5>
              </Card>
              <Card
              ...
              >
                ...
                <h5 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                  How can career interest inventories help you decide on a
