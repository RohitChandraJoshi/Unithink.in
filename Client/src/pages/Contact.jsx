...
function Contact() {
  ...
  return (
    <div className="flex flex-col md:flex-row relative">
      <div className="mt-10">
        <a
          href="https://wa.me/message/GIWSQYCHN67RD1 "
          target="_blank"
      ...
      <div className="flex flex-col md:w-2/3 p-4">
        <div className="mx-auto justify-items-center">
          ...
          <div
            className="md:p-5 lg:p-8 mx-3 sm:mx-auto lg:mx-auto max-w-md md:max-w-lg lg:max-w-3xl mb-10"
            style={{ zIndex: "1" }}
          >
      ...
      <div className="md:w-2/4 p-4" style={{ zIndex: "1" }}>
        <div className="contact-box">
          ...
          <p className="slogan">
            Connect with UniThink Education International for an initial
            consultation with our experts. We delve into the specifics of your
            situation to provide you with tailored solutions and present the
            best options available. Just a minute of your time is all it takes.
            Expect a prompt response as we prioritize your needs and strive to
            deliver excellence.
          </p>

          <div className="contact-details">
            <p style={{ fontWeight: "bold" }}>
              <HiOutlinePhone /> +919663521332 <br /> +919663514338{" "}
            </p>
            <p>
              <HiOutlineLocationMarker /> 305, Tropical Terrace, Basavanagar,{" "}
              <br /> Doddanekkundi, Bangalore North, Bangalore- <br /> 560037,
              Karnataka
            </p>
            <p style={{ fontWeight: "bold" }}>
              <HiMail /> info@unithink.in
            </p>
          </div>
