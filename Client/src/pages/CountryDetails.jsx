    ...
    const fetchCountryDetails = async () => {
      try {
        const response = await axios.get(
          `https://unithink-backend.vercel.app/api/countryDetails/${countryid}`
        );
    ...
    <div className="container mx-auto px-4 py-8">
      {countryDetails && (
        <div>
          ...
          <div className="mb-8">
            <img
              src={countryDetails.top_image}
              alt={countryDetails.c_name}
              className="w-full md:w-5/10 h-auto object-cover rounded-lg shadow-lg mb-4"
            />
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg mb-4">
            ...
            <div className="flex mb-2">
              ...
              <p className="text-gray-800  w-1/2">
                {countryDetails.c_worldrank}
              </p>
            </div>
            <div className="flex mb-2">
              <p className="font-bold text-gray-700 w-1/2">
            ...
            <div className="flex mb-2">
              ...
              <p className="text-gray-800 w-1/2">
                {countryDetails.Average_tution_fee}
              </p>
            </div>
            <div className="flex mb-2">
              <p className="font-bold text-gray-700 w-1/2">
              ...
              <p className="text-gray-800 w-1/2">
                {countryDetails.num_stud_international}
              </p>
            </div>
            <div className="flex mb-2">
              <p className="font-bold text-gray-700 w-1/2">
              ...
              <p className="text-gray-800 w-1/2">
                {countryDetails.avg_cost_living}
              </p>
            </div>
            <div className="flex mb-2">
              <p className="font-bold text-gray-700 w-1/2">
              ...
              <p className="text-gray-800 w-1/2">
                {countryDetails.avg_hostel_price}
              </p>
            </div>
            <div className="flex mb-2">
          ...
          {countryDetails.top_reasons && (
            <div className="bg-white p-4 rounded-lg shadow-lg mb-4">
              <h2 className="text-xl font-semibold mb-2">
                Top Reasons to Study in {countryDetails.c_name}
              </h2>
              <ul className="list-disc list-inside">
                {Object.values(countryDetails.top_reasons).map(
                  (reason, index) => (
          ...
          {countryDetails.uni_list && (
            <div className="bg-white p-4 rounded-lg shadow-lg mb-4">
              <h2 className="text-xl font-semibold mb-2">
                Universities in {countryDetails.c_name}
              </h2>
              <ul className="list-disc list-inside">
                {Object.values(countryDetails.uni_list).map(
                  (university, index) => (
                    <li key={index} className="text-gray-800 mb-2">
                      {university}
                    </li>
