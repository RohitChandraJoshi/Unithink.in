    ...
    const fetchCourseDetails = async () => {
      try {
        const response = await axios.get(
          `https://unithink-backend.vercel.app/api/coursesdetails/${courseId}`
        );
        ...
        <div>
          ...
          <div className="mb-8">
            <img
              ...
              className="w-full md:w-5/5 h-auto object-cover rounded-lg shadow-lg mb-4"
            />
          </div>
          ...
          {courseDetails.countries && (
            <div className="bg-white p-4 rounded-lg shadow-lg mb-4">
              <h2 className="text-xl font-semibold mb-2">
                Countries Offering {courseDetails.course_name}
              </h2>
              {Object.entries(courseDetails.countries).map(
                ([country, details], index) => (
          ...
          <div className="bg-white p-4 rounded-lg shadow-lg mb-4">
            ...
            <ul className="list-disc list-inside">
              {Object.values(courseDetails.career_opportunities).map(
                (opportunity, index) => (
