  ...
  return (
    <div className="bg-white">
      ...
      {loading ? ( // Render logo with blinking effect while loading
        ...
        <>
          <div
            style={{ backgroundImage: `url(${homebgsm})` }}
            className="pr-0 md:pr-52 bg-cover bg-center bg-no-repeat flex justify-center items-center pb-16"
          >
          ...
          <div className="discover">
            <h1 className="mx-auto text-3xl font-bold text-center p-5">
